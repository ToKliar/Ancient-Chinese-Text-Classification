...
train_data_0 = train_data_0.iloc[:train_data_0.shape[0] // 16]

train_data_1 = train_data[train_data['type'] == 1].sample(frac=1).reset_index(drop=True)
train_data_1 = train_data_1.iloc[:train_data_1.shape[0] // 16]

train_data = pd.concat([train_data_0, train_data_1])
train_data = train_data.sample(frac=1).reset_index(drop=True)

with open("../guwen_mid/data/train.txt", 'w', encoding='utf-8') as f:
...
with open("../guwen_mid/data/test.txt", 'w', encoding='utf-8') as f:
...
valid_data_0 = valid_data_0.iloc[:valid_data_0.shape[0] // 8]

valid_data_1 = valid_data[valid_data['type'] == 1].sample(frac=1).reset_index(drop=True)
valid_data_1 = valid_data_1.iloc[:valid_data_1.shape[0] // 8]

valid_data = pd.concat([valid_data_0, valid_data_1])
valid_data = valid_data.sample(frac=1).reset_index(drop=True)

with open("../guwen_mid/data/dev.txt", 'w', encoding='utf-8') as f:
